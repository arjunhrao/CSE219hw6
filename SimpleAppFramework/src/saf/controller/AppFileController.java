...
public class AppFileController {
	...
	PropertiesManager props = PropertiesManager.getPropertiesManager();
		...
		//hw4
                boolean hitOK = app.getWorkspaceComponent().newDialog();
	...
	PropertiesManager props = PropertiesManager.getPropertiesManager();
	    ...
	    String s = app.getDataComponent().getPath();
	...
	fc.setTitle(props.getProperty(LOAD_WORK_TITLE));
		...
		AppFileComponent fileManager = app.getFileComponent();
                ...
                System.out.println("pre - loading data");
                fileManager.loadData(dataManager, selectedFile.getAbsolutePath());
                System.out.println("post - loading data");
                //fileManager.loadProgressBar();
                app.getWorkspaceComponent().reloadWorkspace();
    ...
    public void handleExportRequest() {
        ...
        //hw5
        app.getWorkspaceComponent().export();
        AppMessageDialogSingleton dialog = AppMessageDialogSingleton.getSingleton();
	dialog.show("Export complete", "Your map has been exported");
    }
